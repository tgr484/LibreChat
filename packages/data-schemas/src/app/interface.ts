...
export async function loadDefaultInterface({
  ...
  const loadedInterface: AppConfig['interfaceConfig'] = removeNullishValues({
    ...
    fileAttachOptions: interfaceConfig?.fileAttachOptions,
    toolsDropdown: interfaceConfig?.toolsDropdown,
    audioRecorder: interfaceConfig?.audioRecorder,
    defaultLastSelectedModel: interfaceConfig?.defaultLastSelectedModel,
